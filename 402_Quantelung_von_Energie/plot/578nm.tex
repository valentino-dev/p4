...
\begin{picture}(7200.00,4320.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \csname LTb\endcsname%%
      \put(4354,3158){\makebox(0,0)[r]{\strut{}$f(U_G)=\SI{20.88 +- 0.77}{}\cdot U_G + \SI{8.108 +- 0.075}{\milli V}$}}%
      \csname LTb\endcsname%%
      \put(170,2169){\rotatebox{-270.00}{\makebox(0,0){\strut{}$\sqrt{I-I_0}$/mV}}}%
      \csname LTb\endcsname%%
      \put(3760,135){\makebox(0,0){\strut{}$U_G$/V}}%
      \csname LTb\endcsname%%
      \put(3760,4009){\makebox(0,0){\strut{}$\lambda=\SI{578}{\nano m}$: $U_0=\SI{-0.388 +- 0.015}{V}$ und $\chi^2/\text{ddof}=\SI{0.850}{}$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={360.00bp},height={216.00bp}]{578nm-inc}}%
    \gplfronttext
  \end{picture}%
\endgroup
\end{document}
