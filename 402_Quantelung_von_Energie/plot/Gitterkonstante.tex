...
\begin{picture}(7200.00,4320.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \csname LTb\endcsname%%
      \put(6123,890){\makebox(0,0)[r]{\strut{}$f(\lambda)=\frac{\lambda}{\SI{4527 +- 47}{\angstrom}}$}}%
      \csname LTb\endcsname%%
      \put(170,2169){\rotatebox{-270.00}{\makebox(0,0){\strut{}$[\sin{(\omega_G)}+\sin{(\omega_G+\omega_B-\SI{180}{\degree})}]/\SI{}{rad}$}}}%
      \csname LTb\endcsname%%
      \put(3809,135){\makebox(0,0){\strut{}$\lambda/\SI{}{\nano m}$}}%
      \csname LTb\endcsname%%
      \put(3809,4009){\makebox(0,0){\strut{}$g=\SI{4527 +- 47}{\angstrom}$ und $\chi^2/\text{ddof}=9.920$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={360.00bp},height={216.00bp}]{Gitterkonstante-inc}}%
    \gplfronttext
  \end{picture}%
\endgroup
\end{document}
