...
\begin{picture}(7200.00,4320.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \csname LTb\endcsname%%
      \put(170,2362){\rotatebox{-270.00}{\makebox(0,0){\strut{}$\frac{V_{\text{meter}}\SI{10}{V}}{(100G_2R_f)^2}/\SI{}{\nano V^2}$}}}%
      \csname LTb\endcsname%%
      \put(3906,135){\makebox(0,0){\strut{}Frequenz $f/\SI{}{\kilo Hz}$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={360.00bp},height={216.00bp}]{shot_freq-inc}}%
    \gplfronttext
  \end{picture}%
\endgroup
\end{document}
