...
\begin{picture}(7200.00,4320.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \csname LTb\endcsname%%
      \put(4004,4009){\makebox(0,0){\strut{}H$\alpha$(\SI{656}{nm})-Linie von N2 mit $\chi^2/\textrm{ddof}=\SI{2.17E-01}{}$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={360.00bp},height={216.00bp}]{P-Cygni_N2_gauss}}%
    \gplfronttext
  \end{picture}%
\endgroup
