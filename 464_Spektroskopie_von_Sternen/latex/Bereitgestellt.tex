...
\begin{table}[h]
  \begin{tabular}{cc}
    ...
    \bottomrule
  \end{tabular}
\end{table} %TODO: Parameter auflisten oder irgendwie im Protokoll referenzieren. Generell müssen glaube ich alle Parameter ins Protokoll. // meinst du a0, a2?
...
% TODO: Diskussion des Drucks und chi in saha gleichung
...
Für einen Verlauf, der zu den experimentellen Daten passt, muss $p_\text{e}\ll \SI{10}{Pa}$. %TODO: muss kleiner sein oder??
