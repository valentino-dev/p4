...
Gegenüber der Probe ist eine Klammer, die einen Pt--Ir Draht hält.
...
\begin{figure}[t]
  ...
  \caption{NaioSTM von Nanosurf, Nahaufnahme der Probe.\cite{nanosurf}} \label{fig:naiostm_closeup}
\end{figure}
